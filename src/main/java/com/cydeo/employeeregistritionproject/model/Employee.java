package com.cydeo.employeeregistritionproject.model;
...
//    @NotBlank       // Except null, empty String and only space anything can be accepted.
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd")//after adding this kinda pattern thymeleaf then able to understand it
